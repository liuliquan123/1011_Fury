  ...
  return (
    <div className={classNames(styles.header)}>
      ...
      <div className={classNames(styles.buttons)}>
        ...
        {!profile.id && (
          <Fragment>
            <Link className={classNames(styles.button, styles.desktopLoginButton)} to={referralCode ? `/login?code=${referralCode}` : '/login'}>
            ...
            <Link className={classNames(styles.button, styles.mobileLoginButton)} to={referralCode ? `/login?code=${referralCode}` : '/login'}>
