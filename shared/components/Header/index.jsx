  ...
  return (
    <div className={classNames(styles.header)}>
      ...
      <div className={classNames(styles.buttons)} style={{ gap: '10px' }}>
        ...
        {!profile.id && (
          <Fragment>
            <Link className={classNames(styles.desktopLoginButton)} to={referralCode ? `/login?code=${referralCode}` : '/login'}>
            ...
            <Link className={classNames(styles.mobileLoginButton)} to={referralCode ? `/login?code=${referralCode}` : '/login'}>
